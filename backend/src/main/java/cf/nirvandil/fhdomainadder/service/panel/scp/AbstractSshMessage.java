...
public abstract class AbstractSshMessage {
    ...
    @Setter
    private LogListener listener = (level, message) -> { /* NOOP */ };
     ...
     */
    AbstractSshMessage(Session session, boolean verbose) {
     ...
     */
    Channel openExecChannel(String command) throws JSchException {
     ...
     */
    void waitForAck(InputStream in) throws IOException {
        int b = in.read();
     ...
     */
    void logStats(long timeStarted, long timeEnded, long totalLength) {
